-- =============================================================================
-- F31 Bloque C — CI31.8: Add founder_patterns to get_optimus_context
--
-- Modifies get_optimus_context() to include up to 3 active founder patterns
-- in the context packet, so Optimus can reference behavioral patterns
-- when advising the founder.
-- =============================================================================
...
COMMENT ON FUNCTION get_optimus_context(UUID, UUID) IS
  'P8.2 + F31: Ensambla el context packet de Optimus. '
  ...
  'y founder_patterns (max 3 activos, F31 Bloque C).';
