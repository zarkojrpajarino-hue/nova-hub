-- ============================================================================
-- MIGRACIÓN 00040 — Fix: seed_simulation_data — strategic_blocks created_by
--
-- Bug: strategic_blocks.created_by REFERENCES auth.users(id), pero el seed
-- pasaba p_owner_id que es profiles.id → FK violation en ejecución.
--
-- Fix: eliminar created_by del INSERT en strategic_blocks.
-- Los bloques generados tienen origin='engine' → created_by NULL es correcto.
-- ============================================================================
