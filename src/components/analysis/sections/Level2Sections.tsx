    ...
    <Card>
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center gap-2 text-base">
            <DollarSign className="h-5 w-5 text-green-600" />{t('analysis.pulsoFinanciero')}</CardTitle>
          <SourceBadge type="observed" source={t('analysis.stripeMétricas')} size="sm" />
        </div>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="rounded-lg bg-gray-50 dark:bg-gray-900 px-3 py-2.5 text-center">
            <p className="text-xs text-gray-500 mb-0.5">{t('analysis.runway')}</p>
            <p className="text-lg font-bold text-gray-800 dark:text-gray-200">
          ...
          <div className="rounded-lg bg-gray-50 dark:bg-gray-900 px-3 py-2.5 text-center">
            <p className="text-xs text-gray-500 mb-0.5">{t('analysis.estado')}</p>
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center gap-2 text-base">
            <Users className="h-5 w-5 text-purple-600" />{t('analysis.pipelineYTracción')}</CardTitle>
          {data.source && (
            <SourceBadge
              type={sourceType}
      ...
      <CardContent className="space-y-3">
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-lg bg-gray-50 dark:bg-gray-900 px-3 py-2.5">
            <p className="text-xs text-gray-500 mb-0.5">{t('analysis.dealsActivos')}</p>
        ...
        {data.revenue_potential !== null && data.revenue_potential !== undefined && (
          <div className="rounded-lg bg-purple-50 border border-purple-200 dark:bg-purple-950/30 dark:border-purple-800 px-3 py-2">
            <p className="text-xs text-purple-600 dark:text-purple-400 font-medium">{t('analysis.revenuePotencial')}</p>
