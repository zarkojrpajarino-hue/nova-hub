  ...
  const plans = [
    {
      ...
      price: '29',
      items: t('landing.starterItems', { returnObjects: true }) as string[],
    ...
    },
    {
      ...
      price: '79',
      items: t('landing.proItems', { returnObjects: true }) as string[],
    ...
    },
    {
      ...
      price: '299',
      items: t('landing.enterpriseItems', { returnObjects: true }) as string[],
